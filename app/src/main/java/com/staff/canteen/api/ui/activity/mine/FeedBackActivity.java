...
import com.staff.canteen.api.mvp.presenter.mine.FeedBackPresenter;
import com.staff.canteen.api.mvp.view.mine.FeedBackView;
import com.staff.canteen.api.router.RouterCons;
import com.staff.canteen.api.ui.activity.BaseActivity;
import com.staff.canteen.api.ui.adapter.ImageSelectAdapter;
...
public class FeedBackActivity extends BaseActivity<FeedBackPresenter> implements FeedBackView,ImageSelectAdapter.OnImageClickListener {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        mPresenter.onRequestPermissionsResult(this, requestCode, grantResults);
    }
