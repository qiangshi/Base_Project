package com.staff.canteen.api.helper;
...
public class ToolHelper {
     ...
     * return 返回选择的时间
     */
    private static void selectTime(BaseActivity activity, TextView textView, String dateType,Handler handler) {
     ...
     */
    private static void selectTime(BaseActivity activity, boolean isStartTime, final TextView tvStartTime, final TextView tvEndTime, int showType) {
        Calendar selectedDate = Calendar.getInstance();
        Calendar startDate = Calendar.getInstance();
        Calendar endDate = Calendar.getInstance();
        selectedDate.setTimeInMillis(System.currentTimeMillis());
    ...
    public static void initProvinceData(Context context, Handler handler) {//解析数据
        ...
        String JsonData = getJson("province.json", context);
