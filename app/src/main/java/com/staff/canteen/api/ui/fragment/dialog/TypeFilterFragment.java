...
import com.staff.canteen.api.ui.adapter.TypeFilterAdapter;
import com.staff.canteen.api.utils.ScreenUtils;
...
public class TypeFilterFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Dialog dialog = new Dialog(Objects.requireNonNull(getActivity()), R.style.UpDownDialogStyle);
    ...
    private static void setDialogHeight(WindowManager wm, int count, DialogFragment dialog) {
        ...
        //获取对话框当前的参数值
        WindowManager.LayoutParams p = dialog.getDialog().getWindow().getAttributes();
        //设置为当前屏幕高度的一半
        if (count > 4) {
