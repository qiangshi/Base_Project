package com.staff.canteen.api.mvp.presenter.login;
...
import com.staff.canteen.api.mvp.view.login.LoginView;
import com.staff.canteen.api.net.BaseApiResponse;
...
public class LoginPresenter extends BasePresenter<LoginView> {
    ...
    public void requestLogin(String mobilePhone, String verificationCode, boolean isChecked) {
        ...
        mView.loginSuccess(new LoginBean());
        addSubscription(
