...
import com.staff.canteen.api.App;
...
import com.staff.canteen.api.ui.fragment.dialog.EmptyFragment;
import com.staff.canteen.api.ui.fragment.dialog.LoadingFragment;
import com.staff.canteen.api.ui.fragment.dialog.PopupFragment;
import com.staff.canteen.api.ui.fragment.dialog.PowerFragment;
import com.staff.canteen.api.utils.PermissionPageUtils;
import com.staff.canteen.api.utils.statusbar.StatusBarUtil;
import com.staff.canteen.api.view.SearchBarView;
...
public abstract class BaseActivity<P extends BasePresenter> extends AppCompatActivity implements IView {
    ...
    protected ImageView mBackBtn, mRightBtn, mSearechBtn;
...
//        }
    ...
    protected void initTitle(boolean isShowLeft, String title) {
        initView();
        initTitle(isShowLeft,title,0,0);
    }
    ...
    protected void initSearchTitle(){
        ...
        mSearechBtn.setVisibility(View.GONE);
    ...
    protected void initRightTitle(String title, int rightImgResId) {
        initTitle(false,title, rightImgResId, 0);
    }
     ...
     * @param title  标题内容
     * @param rightImgResId  最右边图标id  >0 显示  <=0  不显示
     * @param searchResId 搜索图标id
     */
    private void initTitle(boolean isShowLeft,String title, int rightImgResId, int searchResId) {
        initView();
        ...
        if (searchResId > 0) {
            mSearechBtn.setImageResource(rightImgResId);
            mSearechBtn.setVisibility(View.VISIBLE);
        } else {
            mSearechBtn.setVisibility(View.GONE);
        }
    }
    ...
    private void initView() {
        ...
        mRightBtn = findViewById(R.id.btn_car_shopping);
        mSearechBtn = findViewById(R.id.btn_search);
